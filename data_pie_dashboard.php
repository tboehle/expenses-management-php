...
$query = "SELECT sum(betrag) as Auszahlungen from transaktion WHERE zahlungsart='Auszahlung' AND datum BETWEEN DATE_SUB(CURRENT_DATE(),INTERVAL 1 month) AND CURRENT_DATE()
...
$query = "SELECT sum(betrag) as Einzahlungen from transaktion WHERE zahlungsart='Einzahlung' AND datum BETWEEN DATE_SUB(CURRENT_DATE(),INTERVAL 1 month) AND CURRENT_DATE()
          AND transaktion.user = $userid";
